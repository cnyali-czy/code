...
using namespace std;
const int maxn = 100000 + 10, maxm = 100000 + 10, maxblock = 100000;
...
bool cmp2(Question A, Question B) {return A.r < B.r || A.r == B.r && A.time < B.time;}
bool cmp3(Question A, Question B) {return A.r < B.r || A.r == B.r && A.time > B.time;}
